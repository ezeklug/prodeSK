using EstadisticasIndependiente.Application.Common.Models;
using EstadisticasIndependiente.Application.TodoItems.Commands.CreateTodoItem;
using EstadisticasIndependiente.Application.TodoItems.Commands.DeleteTodoItem;
using EstadisticasIndependiente.Application.TodoItems.Commands.UpdateTodoItem;
using EstadisticasIndependiente.Application.TodoItems.Commands.UpdateTodoItemDetail;
using EstadisticasIndependiente.Application.TodoItems.Queries.GetTodoItemsWithPagination;
